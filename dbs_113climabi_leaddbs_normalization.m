...
message = sprintf('%s: %s %s %s',date,'Normalization (with brainshift correction) of fifty-two patients took',string(sec),'(hh:mm:ss).');
...
% - Lead-DBS Job created on 13-Oct-2022 21:32:44 -
