...
message = sprintf('%s: %s %s %s',date,'Normalization (with brainshift correction) of one hundred and twelve patients took',string(sec),'(hh:mm:ss).');
...
%% set-up normalization options for Lead-DBS
% - Lead-DBS Job created on 22-Jan-2023 13:58:49 -
% --------------------------------------
