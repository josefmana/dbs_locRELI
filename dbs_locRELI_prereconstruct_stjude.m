% - Lead-DBS Job created on 09-Feb-2023 08:36:12 -
% --------------------------------------
tic % initiate timer
...
message = sprintf('%s: %s %s %s',date,'Pre-reconstruction (via TraC/CORE) of thirty-eight patients with St. Jude electrodes took',string(sec),'(hh:mm:ss).');
