% - Lead-DBS Job created on 29-Jan-2023 11:23:52 -
% --------------------------------------
tic % initiate timer

%% set-up options and do the thing
lead path;
% read options for Medtronic and St. Jude electrodes respectively
...
message = sprintf('%s: %s %s %s',date,'Pre-reconstruction (via TraC/CORE) of one hundred and four patients took',string(sec),'(hh:mm:ss).');
...
%% prepare options for the patients with Medtronic 3389 electrodes
function options = getoptslocal_medtronic
    ...
    options.reconmethod = 'TRAC/CORE (Horn 2015)';
...
%% prepare options for the patients with St. Jude electrodes (all short)
